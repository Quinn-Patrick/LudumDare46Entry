...
if(selected){
	if(keyboard_lastchar != "" || keyboard_lastkey == vk_backspace){
		...
		contents = string_replace_all(contents, "\r", "");
		contents = string_replace_all(contents, "\b", "");
		contents = string_replace_all(contents, "\f", "");
		contents = string_replace_all(contents, "\t", "");
		contents = string_replace_all(contents, "\v", "");
		contents = string_replace_all(contents, "\a", "");
